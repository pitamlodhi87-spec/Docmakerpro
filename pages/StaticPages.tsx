  ...
  <div className="max-w-4xl mx-auto bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100">
    ...
    <div className="prose prose-blue max-w-none text-gray-600 space-y-8">
      <section>
        ...
        <p>
          At FileMakerOn, accessible from https://filemakeron.com, one of our main priorities is the privacy of our visitors. 
          This Privacy Policy document contains types of information that is collected and recorded by FileMakerOn and how we use it.
        </p>
        <p>
      ...
      <section className="bg-blue-50 p-6 rounded-xl border border-blue-100">
        ...
        <p>
          Unlike traditional conversion websites, FileMakerOn operates primarily using <strong>Client-Side Technology</strong>. 
      ...
      <section>
        ...
        <p>
          FileMakerOn follows a standard procedure of using log files. These files log visitors when they visit websites. 
      ...
      <section>
        ...
        <p>
          Like any other website, FileMakerOn uses 'cookies'. These cookies are used to store information including visitors' preferences, 
...
export const About: React.FC = () => (
  <div className="max-w-4xl mx-auto space-y-12">
    ...
    <div className="bg-white p-8 md:p-12 rounded-2xl shadow-sm border border-gray-100 text-center">
      <h1 className="text-4xl font-extrabold text-gray-900 mb-6">About FileMaker<span className="text-chrome-blue">On</span></h1>
      <p className="text-xl text-gray-600 max-w-2xl mx-auto leading-relaxed">
        We are a passionate team of developers dedicated to making the web faster, safer, and more accessible. 
        FileMakerOn provides professional-grade image tools completely free of charge.
      </p>
    </div>
      ...
      <div className="flex flex-col md:flex-row gap-12 items-center">
        <div className="flex-1 space-y-6">
          ...
          <p className="text-gray-600 leading-relaxed">
            Founded in 2024, FileMakerOn was created to solve a common frustration: simple image tasks shouldn't require complex software or unsafe websites.
          </p>
          <p className="text-gray-600 leading-relaxed">
...
export const Contact: React.FC = () => (
  <div className="max-w-3xl mx-auto bg-white p-8 rounded-2xl shadow-sm border border-gray-100">
    ...
    <div className="mt-8 pt-8 border-t border-gray-100 text-center text-sm text-gray-500">
      <p>Alternatively, you can email us directly at: <a href="mailto:support@filemakeron.com" className="text-chrome-blue hover:underline">support@filemakeron.com</a></p>
    </div>
  </div>
);
...
export const Terms: React.FC = () => (
    ...
    <div className="prose prose-blue max-w-none text-gray-600 space-y-6">
      <section>
        ...
        <p>
          By accessing and using FileMakerOn, you accept and agree to be bound by the terms and provision of this agreement.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          Permission is granted to temporarily download one copy of the materials (information or software) on FileMakerOn's website for personal, non-commercial transitory viewing only.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          The materials on FileMakerOn's website are provided on an 'as is' basis. FileMakerOn makes no warranties, expressed or implied, and hereby disclaims and negates all other warranties including, without limitation, implied warranties or conditions of merchantability, fitness for a particular purpose, or non-infringement of intellectual property or other violation of rights.
        </p>
      </section>
      ...
      <section>
        ...
        <p>
          In no event shall FileMakerOn or its suppliers be liable for any damages (including, without limitation, damages for loss of data or profit, or due to business interruption) arising out of the use or inability to use the materials on FileMakerOn's website.
        </p>
      </section>
    </div>
  </div>
